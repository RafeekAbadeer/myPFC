...
def display_credit_cards(content_frame, toolbar):
    ...
    export_action.triggered.connect(lambda: export_credit_cards_data(content_frame, table_view))

    # Load data
    load_credit_cards(table_view)


def export_credit_cards_data(parent, table_view):
    """
    ...
    export_table_data(parent, table_view, "credit_cards_export", "Credit Cards List")
